;(function(exports) {
  ...
  var generateMarkup = function(calendars, clazz, calendarId) {
    ...
    result.innerHTML += '<input name="add-to-calendar-checkbox" onchange=handleClick(this) class="add-to-calendar-checkbox"  id="checkbox-for-' + calendarId + '" type="checkbox"><a id="myLink">Add To Calander</a>';
